...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 14 déc. 2023 à 15:56
...
--
-- Base de données : `essaie qr code`
--
...
CREATE TABLE IF NOT EXISTS `membre` (
  ...
  `poste` varchar(1200) COLLATE utf8mb4_general_ci NOT NULL,
  `QR` varchar(1200) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
